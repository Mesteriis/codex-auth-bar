...
public struct RegistryV4: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        if let activeAccountKey { try values.encode(activeAccountKey, forKey: .activeAccountKey) }
        else { try values.encodeNil(forKey: .activeAccountKey) }
        if let previousActiveAccountKey { try values.encode(previousActiveAccountKey, forKey: .previousActiveAccountKey) }
        else { try values.encodeNil(forKey: .previousActiveAccountKey) }
        if let activeAccountActivatedAtMilliseconds {
            try values.encode(activeAccountActivatedAtMilliseconds, forKey: .activeAccountActivatedAtMilliseconds)
        } else {
            try values.encodeNil(forKey: .activeAccountActivatedAtMilliseconds)
        }
